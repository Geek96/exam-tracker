...
帮助学生集中管理课程、考试、章节进度、教材资料，并通过 AI 助手制定高效复习计划。
...
- [x] JS 缓存破坏版本号机制（`course.js?v=N`，当前 v=29）

### M8 — 课程与考试管理重构 ✅
> 2026-04-30

- [x] 修复 AI 对话持久化导致 localStorage 超配额、课程资料/章节/进度丢失的风险
- [x] 修复 AI 历史会话中用户输入显示为系统提示词的问题
- [x] AI 可读 Markdown 文件选择改为助手顶部下拉选择器，移除资料卡片 `🤖` 按钮
- [x] 移除课程页 topbar 初始“加载中…”误显示
- [x] 应用名称从“复习追踪器”更新为“课程与考试管理”
- [x] 添加课程表单移除考试日期与章节总数字段
- [x] 新增独立考试管理模块：考试名称、日期、类型、倒计时与删除
