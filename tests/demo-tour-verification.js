...
assert(html.includes('material-rag.js?v=44'), 'course.html should cache-bust material-rag.js to v=44');
assert(html.includes('course.js?v=44'), 'course.html should bump course.js to v=44');
