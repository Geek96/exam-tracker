...
assert(html.includes('material-rag.js?v=41'), 'course.html should cache-bust material-rag.js to v=41');
assert(html.includes('course.js?v=41'), 'course.html should bump course.js to v=41');
