...
assert(html.includes('material-rag.js?v=47'), 'course.html should cache-bust material-rag.js to v=47');
assert(html.includes('course.js?v=48'), 'course.html should bump course.js to v=48');
